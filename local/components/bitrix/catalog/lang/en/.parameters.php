...
$MESS["PAGER_TEMPLATE_TIP"] = "Name of a breadcrumb navigation template. If empty, the default template (<i>module.listing</i>) will be used. Alternatively, you can use the <i>orange</i> template.";
