...
/* получим в $filterElements элементы из инфоблоков - фильтров */
...
$requestURLDir = $request->getRequestedPageDirectory().'/';
...
else
{
    ...
    //elseif(isset($arVariables["action"]) && in_array($arVariables["action"], $arCompareCommands))
